...
<img src="Res/images/044417fdc1cb787fed6996ea10ab0082.png" width="380" alt="Netor.Cortana" />
...
它内置 **Ollama 本地协议代理**，可以把 Cortana 里配置好的远程模型、企业模型、国产模型、私有 API 模型，对外伪装成本机 Ollama 模型。
...
Cortana 内置轻量 WebSocket 服务，方便外部应用连接主对话或订阅内部对话事件。
...
这让 Cortana 不只是一个 GUI 应用，也可以成为其他程序背后的 AI 对话服务。
...
- 当前代码版本以 `Src/Netor.Cortana.UI/Netor.Cortana.UI.csproj` 中的 `<Version>` 为准；当前为 **1.3.5**。
...
**Netor.Cortana** — 别再只让 AI 说话了，让它接管工具，开始干活。
