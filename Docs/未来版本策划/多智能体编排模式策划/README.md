...
> **当前版本**：v2.3 阶段 6 收口（Token 聚合 + 工具权限任务级收窄 + UI 体验统一 + 搜索 + Banner 频率限制；用户决策 1-A / 2-B / 3-A / 4-A / 5-B / 6-A / 7-A / 8-A / 9-A / 10-A / 11-A / 12-A + 6-1-A/B/C / 6-2-A/B/C / 6-3-A/B/C/D 已落地）  
